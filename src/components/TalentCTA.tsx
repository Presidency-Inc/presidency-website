      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to accelerate your innovation with expert talent?
          </h2>
          <p className="text-lg md:text-xl text-blue-100 mb-8">
            Connect with our team to discuss your AI and data engineering talent needs. We'll help you build the right team for your specific requirements.
          </p>
