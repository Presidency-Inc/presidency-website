...
const TalentCTA = () => {
  return (
    <section className="py-16 md:py-24 relative overflow-hidden bg-gradient-to-br from-indigo-900 to-purple-900 text-white">
      {/* Background Pattern */}
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              <div className="flex items-center mb-6">
                <Users className="h-10 w-10 mr-4 text-purple-300" />
