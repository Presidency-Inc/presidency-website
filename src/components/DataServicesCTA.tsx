            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="bg-gradient-to-br from-blue-500 to-indigo-600 p-12 lg:p-16 flex items-center justify-center">
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">Transform Your Data Operations</h3>
                  <p className="text-blue-100 max-w-sm mx-auto">
                    Join organizations that have improved efficiency and unlocked insights with our data engineering expertise
                  </p>
                </motion.div>
              </div>
              ...
              <div className="p-12 lg:p-16">
                ...
                >
                  <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900 leading-tight">
                    Ready to Transform Your Business with <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Data-Driven Solutions?</span>
                  </h2>
                  
                  <p className="text-lg text-gray-600">
                    Connect with our data engineering experts to discuss how our services can optimize your data operations, unlock insights, and drive business growth.
                  </p>
...
export default DataServicesCTA;
