  ...
  return (
    <nav className="fixed top-10 left-0 right-0 z-40 bg-white/80 backdrop-blur-md border-b border-gray-100">
      ...
      {isMobile && mobileMenuOpen && (
        <div className="fixed inset-0 bg-white z-50 overflow-y-auto flex flex-col h-full w-full">
          {mobileSubmenuOpen === null ? (
            <div className="flex flex-col h-full">
              ...
              <div className="sticky bottom-0 pt-4 border-t border-gray-100 px-4 py-4 bg-white pb-safe mt-auto">
