                ...
                <BreadcrumbList>
                  <BreadcrumbItem>
                    <BreadcrumbLink asChild>
                      <Link to="/services/databricks" className="flex items-center text-gray-600 hover:text-gray-900">
                        <ArrowLeft className="h-4 w-4 mr-2" />
                        Back to Databricks Services
                      </Link>
                    </BreadcrumbLink>
                  </BreadcrumbItem>
                </BreadcrumbList>
          ...
          <div className="w-1/2 bg-gray-900 text-white p-8 h-full flex flex-col pb-12">
            ...
            <div className="space-y-8 mb-8">
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg">
                  Accelerated ETL with 3-5x faster data processing
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg">
                  Delta Lake optimization for reliable data lakes at scale
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg">
                  Expert Databricks certified team with real-world experience solving complex data challenges
                </p>
              </div>
            </div>
              ...
              <div className="mb-4">
                <Breadcrumb>
                  <BreadcrumbList>
                    <BreadcrumbItem>
                      <BreadcrumbLink asChild>
                        <Link to="/services/databricks" className="flex items-center text-gray-300 hover:text-white">
                          <ArrowLeft className="h-4 w-4 mr-2" />
                          Back to Databricks Services
                        </Link>
                      </BreadcrumbLink>
...
export default DatabricksInterestForm;
