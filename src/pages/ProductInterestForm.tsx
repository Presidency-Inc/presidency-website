        ...
        <div className="flex h-screen">
          ...
          <div className="w-1/2 bg-gray-900 text-white p-8 h-full flex flex-col pb-12">
            ...
            <p className="text-lg mb-10">
              We're excited to demonstrate how you can leverage our AI, Data and Cloud technologies to create impact
            </p>
            ...
            <div className="space-y-8 mb-8">
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg">
                  Artificial Intelligence platform to deliver intelligence capabilities to streamline and improve your business
                </p>
              </div>
